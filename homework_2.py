...
# The TSM_Data variable is getting TSM's historical data for the last 2 years.
...
#I am also titlting it "Close and Volume:" to make it clear what data is being printed.
print("\nClose and Volume:")
print(TSM_data[["Close","Volume"]])

#Then so we don't print the entire DataFrame, I am just printing the data for September 2025.
#I put the september.index aher so that it does the same strip as before but with september's index.
september.index = september.index.date
print("\nSeptember 2025:")
print(september)
...
#The last line here is getting the average daily return of TSM and titling it average daily return.
TSM_data['Daily Returns'] = TSM_data['Close'].pct_change()
TSM_data['Average Daily Return'] = TSM_data['Daily Returns'].mean()
average_daily_return = TSM_data['Daily Returns'].mean()
...
#After it will print the value of the maximum value with the variable of highest_volume.
...
#iloc selects the row position. It does this by row number counting from 0. 
#The print statement will print the text Next Day Return and then pop in the value for that as a % with 2x decimal places.

next_day_return = TSM_data['Daily Returns'].iloc[row_position + 1]
...
print(f"\n5-Day Return: {five_day_return:.2%}")
